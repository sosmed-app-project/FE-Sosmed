...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 flex items-center justify-between bg-white rounded-lg shadow-md px-4">
      {/* Logo */}
        ...
        <div className="relative">
            ...
            {isMenuOpen && (
              <div className="absolute top-12 right-0 bg-white shadow-md rounded-md p-2 w-32">
                <ul>
                  <li className="hover:bg-blue-100 rounded-sm cursor-pointer py-2 px-3"onClick={handleProfile}>Profile</li>
                  <li className="hover:bg-blue-100 rounded-sm cursor-pointer py-2 px-3" >Dark Mode</li>
                </ul>
              </div>
            )}
          </div>
